...
class _SignInScreenState extends State<SignInScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: BlocProvider(
        create:(_)=>SignInAuthCubit(),
        child: BlocConsumer<SignInAuthCubit,AuthSignInStates>(
          listener: (context, state) {
            ...
            if(state is AuthSignInErrorState) {
              ...
              DialogUtils.showMassagingDialog(context,state.errorMsg,);
            }
            ...
            if(state is AuthSignInInitialState){
              Navigator.of(context,rootNavigator:true).pop();
            }
          },
                ...
                child: Column(
                  children: [
                    ...
                    CustomBtn(
                      ...
                      onPressed: () {
                        if(formKey.currentState?.validate() ?? false){
                          context.read<SignInAuthCubit>().signIn(
                    ...
                    CustomBtn(
                      ...
                      onPressed: () {
                        context.read<SignInAuthCubit>().signInWithGoogle();
                      },
